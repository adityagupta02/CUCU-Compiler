...
functionDef  : 	dataType ID LPAREN argList RPAREN LCBRACE funBody RETURN exp SEMICOL RCBRACE		{fprintf(yparse,"func_end\n");} 
		| dataType ID LPAREN RPAREN LCBRACE funBody RETURN exp SEMICOL RCBRACE			{fprintf(yparse,"func_end\n");} 
		;
